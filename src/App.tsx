...
import ParallaxScrollDemo from '../packages/motion/src/playground/parallax-test';

// Routes 안에 추가
<Route path="/playground/parallax-test" element={<ParallaxScrollDemo />} />
...
function App() {
  return (
    <Routes>
      ...
      {/* Motion 패키지의 Playground 라우트 */}
      <Route path="/playground/parallax-test" element={<ParallaxTestPage />} />
    </Routes>
  );
}
export default App;
